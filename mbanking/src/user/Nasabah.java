...
public class Nasabah{
  ...
  // method transfer
    public boolean updateSaldoPengirim(int tempt) {
      MyConnection myConnection = new MyConnection();
      PreparedStatement ps;
    ...
    public int getSaldoPenerima(String idPenerima, int jumlah) {
      MyConnection myConnection = new MyConnection();
      PreparedStatement ps;
      ResultSet rs;
    ...
    public boolean updateSaldoPenerima(String idPenerima, int tempt) {
      MyConnection myConnection = new MyConnection();
      PreparedStatement ps;
